...
import { SelectField, TextareaField } from "@/app/_components/ui/form-field";
      ...
      <div className="flex flex-col gap-6">
         ...
         <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
            <div className="max-w-lg space-y-4">
               ...
               <TextareaField
                  label="Descrição do problema / solicitação (opcional)"
                  id="problemDescription"
                  registration={register("problemDescription")}
                  error={errors.problemDescription?.message}
                  placeholder="Será usada ao gerar a ordem de serviço a partir deste orçamento."
               />
