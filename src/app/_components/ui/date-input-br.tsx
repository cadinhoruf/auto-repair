  ...
  return (
    <div className={`flex flex-col gap-1.5 ${className}`}>
      ...
      <input
        ...
        disabled={disabled}
        className="h-9 rounded-lg border border-gray-300 bg-white px-3 text-sm text-gray-900 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20"
      />
